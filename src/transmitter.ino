 ...
 * Title: Wireless Joystick and IMU Controller
 * Author: Chandra Prakash S
 * Date: 19.06.2024
 * Description: 
 * This Arduino sketch is designed to read inputs from two joysticks, multiple buttons, and an MPU6050 IMU sensor,and transmit this data wirelessly using an nRF24L01 module. The IMU sensor provides additional control inputs by reading accelerometer and gyroscope data. This setup can be used for remote control applications, such as controlling a robot or drone.
...
void loop() {
  ...
  if (digitalRead(t1) == 0) {
    read_IMU();    // Use MPU6050 instead of Joystick 1 for controlling left, right, forward and backward movements
  }
